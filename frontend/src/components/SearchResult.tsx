    ...
    return(
        <div className="bg-background-500 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            <div className="flex justify-between items-center mb-4">
                <div>
                    <h3 className="text-xl text-white-100 font-semibold overflow-hidden whitespace-nowrap overflow-ellipsis" style={{ maxHeight: '1.5em', maxWidth: '13em' }} title={result.videoTitle}>
                        {result.videoTitle}
                    </h3>
