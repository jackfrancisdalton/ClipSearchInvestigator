...
from app.pydantic_schemas.search_results import Match, TranscriptResult
...
async def fetch_transcript_matches(videos: List[Dict[str, Any]], search_terms: List[str]) -> List[TranscriptResult]:
